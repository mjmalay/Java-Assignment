...
class RegistrationForm extends JFrame 
{
    ...
    RegistrationForm()
    {
        ...
        cn.add(l9);cn.add(tf7);
        l9.setBounds(50,150,100,30);
        tf7.setBounds(110,150,170,30);

        cn.add(l2);cn.add(tf2);
        l2.setBounds(50, 200,100,30);
        tf2.setBounds(110, 200, 170, 30);

        cn.add(cb2);cn.add(l10);
        l10.setBounds(50,250,100,30);
        cb2.setBounds(114,250,100,30);
        cb2.addItem("Mech.");
        cb2.addItem("EE");
        cb2.addItem("MCA");
        cb2.addItem("ME");
        ...
        rb1.setBounds(107, 400,100,30);
        rb1.setSelected(true);
        rb2.setBounds(230, 400,100,30);
        rb2.setSelected(false);
        bg.add(rb1);bg.add(rb2);

        cn.add(l6);cn.add(c1);cn.add(c2);cn.add(c3);
        l6.setBounds(50,450,100,30);
        c1.setBounds(128,450,100,30);
        c2.setBounds(235,450,100,30);
        c3.setBounds(342,450,100,30);

        cn.add(l7);cn.add(tf5);cn.add(tf6);cn.add(l8);
        l7.setBounds(50,500, 100, 30);
        tf5.setBounds(121, 500, 150, 30);
        l8.setBounds(50,550, 100, 30);
        tf6.setBounds(121, 550, 150, 30);

        cn.add(bt1);cn.add(bt2);
        bt1.setBounds(128,620,100,30);bt1.setBackground(Color.cyan);
        bt2.setBounds(260,620,100,30);bt2.setBackground(Color.cyan);
